"use strict";
// From: https://github.com/akretion/openerp-web/blob/92341e74475881ab83adfd35f17a18d8edc7f2a9/addons/web/static/lib/py.js/lib/py.js
// Credits to: https://openerp-web-v7.readthedocs.io/en/stable/
var py = {};
    ...
    return function tokenize(s) {
        ...
        while (pseudoprog.lastIndex < max) {
            ...
            if (number_pattern.test(token)) {
                ...
                throw new Error("Tokenizing failure of <<" +
                    s +
                    ">> at index " +
                    start +
                    " for token [[" +
...
py.PY_parseArgs = function PY_parseArgs(argument, format) {
    ...
    var name = function (spec) {
        ...
        throw new Error("TypeError: unknown format specification " + JSON.stringify(spec));
    };
    var spec;
    ...
    for (var j = i; j < format.length; ++j) {
        ...
        var n = name(spec);
        if (n in out) {
            throw new Error("TypeError: function got multiple values " +
    ...
    for (var key in kwargs) {
        throw new Error("TypeError: function got an unexpected keyword argument '" + key + "'");
    }
...
py.PY_str = function (o) {
    ...
    throw new Error("TypeError: __str__ returned non-string (type " + typename(v) + ")");
};
...
py.PY_isTrue = function (o) {
    ...
    throw new Error("TypeError: __nonzero__ should return bool, returned " + typename(res));
};
...
py.PY_size = function (o) {
    if (!o.__len__) {
        throw new Error("TypeError: object of type '" + typename(o) + "' has no len()");
    }
    var v = o.__len__();
    if (typeof v !== "number") {
...
py.PY_getItem = function (o, key) {
    ...
    if (!py.PY_isInstance(key, py.object)) {
        throw new Error("TypeError: __getitem__ must return a py.js object, got " + typename(res));
    }
    return res;
};
...
py.PY_negative = function (o) {
    if (!o.__neg__) {
        throw new Error("TypeError: bad operand for unary -: '" + typename(o) + "'");
    }
    return o.__neg__();
};
...
py.type = function type(name, bases, dict) {
    ...
    if (!bases || bases.length === 0) {
        ...
        throw new Error("ValueError: can't provide multiple bases for a " + "new type");
    }
    var base = bases[0];
...
py.float = py.type("float", null, {
    __init__: function () {
        ...
        if (py.PY_isInstance(value, py.object) && "__float__" in value) {
            ...
            throw new Error("TypeError: __float__ returned non-float (type " + typename(res) + ")");
        }
...
py.abs = new py.PY_def.fromJSON(function abs() {
    ...
    if (!args.number.__abs__) {
        throw new Error("TypeError: bad operand type for abs(): '" + typename(args.number) + "'");
    }
...
py.evaluate = function (expr, context) {
    ...
    switch (expr.id) {
        ...
        case "(string)":
            return py.str.fromJSON(PY_decode_string_literal(expr.value, expr.unicode));
        case "(number)":
